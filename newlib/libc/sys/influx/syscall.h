...
#define __inline_syscall0(num, ret) __asm__ volatile("int $0x80" : "=a"(ret) : "a"(num));

#define __inline_syscall1(num, ret, arg1) \
    __asm__ volatile("mov %2, %%rdx; int $0x80" : "=a"(ret) : "a"(num), "r"((uint64_t)(arg1)));

#define __inline_syscall2(num, ret, arg1, arg2)                          \
    __asm__ volatile("push %3; push %2; pop %%rdx; pop %%rdi; int $0x80" \
                     : "=a"(ret)                                         \
                     : "a"(num), "r"((uint64_t)(arg1)), "r"((uint64_t)(arg2)));

#define __inline_syscall3(num, ret, arg1, arg2, arg3)                                        \
    __asm__ volatile("push %4; push %3; push %2; pop %%rdx; pop %%rdi; pop %%rsi; int $0x80" \
                     : "=a"(ret)                                                             \
                     : "a"(num), "r"((uint64_t)(arg1)), "r"((uint64_t)(arg2)),               \
                       "r"((uint64_t)(arg3)));
...
#define __inline_syscall4(num, ret, arg1, arg2, arg3, arg4)                                    \
    __asm__ volatile(                                                                          \
        "push %5; push %4; push %3; push %2; pop %%rdx; pop %%rdi; pop %%rsi; pop %%r10; int " \
        "$0x80"                                                                                \
        : "=a"(ret)                                                                            \
        : "a"(num), "r"((uint64_t)(arg1)), "r"((uint64_t)(arg2)), "r"((uint64_t)(arg3)),       \
          "r"((uint64_t)(arg4)));
